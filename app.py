...
กรุณาตอบโดยแบ่งเป็น 2 ส่วนชัดเจนดังนี้:

**จากข้อมูลที่มี:**
[ตอบเฉพาะส่วนที่ข้อมูลอ้างอิงข้างต้นรองรับโดยตรง ถ้าไม่มีข้อมูลเกี่ยวข้องเลย ให้เขียนว่า "ไม่มีข้อมูลในส่วนนี้"]

**ความรู้เพิ่มเติม (ไม่ได้ยืนยันจากข้อมูลอ้างอิง):**
[ถ้าต้องการเสริมความรู้ทั่วไปเพื่อตอบคำถามให้ครบถ้วนขึ้น ใส่ตรงนี้ พร้อมระบุว่าเป็นความรู้ทั่วไป ไม่ใช่ข้อมูลยืนยัน หากไม่จำเป็นต้องเสริม ให้เขียนว่า "ไม่มี"]
