...
knowledge_base = [
    "ผู้มีเงินได้พึงประเมินถึงเกณฑ์ที่กฎหมายกำหนดมีหน้าที่ต้องยื่นแบบแสดงรายการภาษีเงินได้บุคคลธรรมดา แม้ว่าเมื่อคำนวณแล้วเงินได้สุทธิจะไม่ถึง 150,000 บาทและได้รับยกเว้นภาษีก็ตาม เกณฑ์เงินได้สุทธิ 150,000 บาท เป็นเกณฑ์ 'ยกเว้นภาษี' ไม่ใช่เกณฑ์ 'ยกเว้นการยื่นแบบ' ทั้งสองเรื่องนี้แยกจากกัน",
...
# 5. เอาคำตอบจากที่ปรึกษา กลับมาให้ลูกค้า พร้อมบอกว่าอ้างอิง
